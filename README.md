...
Spendsync is a modern full-stack expense tracking application that helps users manage income, expenses, and savings with a clean dashboard and real-time financial insights. The application provides an intuitive UI, analytics, and transaction management to help users understand and control their finances effectively.

---

# 🚀 Live Demo

🔗 https://spendsync-1wix.onrender.com
